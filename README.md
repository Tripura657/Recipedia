...
- Enter ingredients like `tomato, onion` to see matching recipes
- Search for a known recipe like `Pasta`

---

## 📤 Output

- Displays a list of matching recipes
- On clicking a recipe: full detail view + download/share PDF option
...
GitHub: [Tripura657](https://github.com/Tripura657)  
LinkedIn: [Tripura Tejasri](https://www.linkedin.com/in/tripura-tejasri-gajula-3840642a2/)
